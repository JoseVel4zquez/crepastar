...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->setXY(60, 15);
        $this->Cell(100, 8, 'Reporte de ventas', 0, 1, 'C', 0);
        $this->Ln(15);
        $this->Cell(100, 9, 'Total de ventas: ' . '$' . $totalR . 'Mxn', 0, 1, 'C', 0);
        $this->Ln(15);
        ...
        $this->image($pic, 130, 25, 100, 0, 'png');
    }
...
$pdf->Cell(30, 8, 'Codigo', 'B', 0, 'C', 0);
$pdf->Cell(35, 8, 'Fecha y hora', 'B', 0, 'C', 0);
...
while ($row = $res->fetch_assoc()) {
    $pdf->Ln(0.6);
    $pdf->setX(15);
    $pdf->Cell(10, 8, $row['id_usuario'], 'B', 0, 'C', 1);
    $pdf->Cell(60, 8, $row['usuarioNombre'], 'B', 0, 'C', 1);
    $pdf->Cell(30, 8, $row['codigo'], 'B', 0, 'C', 1);
    $pdf->Cell(35, 8, $row['created_at'], 'B', 0, 'C', 1);
    $pdf->Cell(50, 8, '$' . $row['ventaUsuario'] . 'Mxn', 'B', 1, 'C', 1);
}
